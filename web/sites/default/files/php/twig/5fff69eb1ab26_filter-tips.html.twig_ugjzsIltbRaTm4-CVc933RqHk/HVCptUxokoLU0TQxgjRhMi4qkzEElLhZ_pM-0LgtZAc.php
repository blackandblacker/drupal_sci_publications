...
class __TwigTemplate_4b97f93a54a9708b7ca798f795efe007d37ee3506a3ae340f435c270fe75376d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\project_drupal\\publications\\web\\core\\themes\\seven\\templates\\classy\\content-edit\\filter-tips.html.twig");
    }
